...
class ToolsManager(QWidget):
    ...
    def setup_ui(self):
        ...
        tools_group.setFont(QFont("Segoe UI", 9, QFont.Weight.Bold))
        ...
        command_group.setFont(QFont("Segoe UI", 9, QFont.Weight.Bold))
        ...
        target_label.setStyleSheet("color: #cbd5e0; min-width: 60px;")
        target_layout.addWidget(target_label)
        
        self.target_input = QLineEdit()
        self.target_input.setFont(QFont("Segoe UI", 8))
        ...
        options_label.setFont(QFont("Segoe UI", 8))
        options_label.setStyleSheet("color: #cbd5e0; min-width: 60px;")
        options_layout.addWidget(options_label)
        
        self.options_input = QLineEdit()
        self.options_input.setFont(QFont("Segoe UI", 8))
        ...
        custom_label.setFont(QFont("Segoe UI", 8))
        custom_label.setStyleSheet("color: #cbd5e0; min-width: 60px;")
        custom_layout.addWidget(custom_label)
        
        self.custom_input = QLineEdit()
        self.custom_input.setFont(QFont("Segoe UI", 8))
        ...
        self.execute_btn.setFont(QFont("Segoe UI", 8, QFont.Weight.Bold))
        ...
        self.stop_btn.setFont(QFont("Segoe UI", 8))
