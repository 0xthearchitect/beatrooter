...
class DynamicEdge(QGraphicsPathItem):
    def __init__(self, source_node, target_node, edge_data=None):
        ...
        self.normal_color = QColor(111, 144, 186, 145)
        self.hover_color = QColor(144, 177, 220, 175)
        self.selected_color = QColor(175, 113, 140, 190)
        
        self.current_color = self.normal_color
        self.line_width = 1.15
        
        self.label_text = QGraphicsSimpleTextItem(self)
        self.label_text.setFont(QFont("Consolas", 7, QFont.Weight.Normal))
        self.label_text.setBrush(QBrush(QColor(142, 163, 193)))
