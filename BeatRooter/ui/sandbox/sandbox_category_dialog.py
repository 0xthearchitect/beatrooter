...
class SandboxCategoryDialog(QDialog):
    ...
    def setup_ui(self):
        ...
        self.subheader_label = QLabel("Choose the category of objects you want to work with")
        ...
        categories = [
            {
                ...
                'description': 'Windows, Linux distributions, files and folders',
                'color': self.colors['accent_blue'],
                'icon': 'OS',
                'object_count': '6 objects'
            },
            {
                'id': 'network_devices', 
                'name': 'Network Devices',
                'description': 'Computers, servers, routers, switches, firewalls',
            ...
            },
            {
                ...
                'description': 'Web servers, databases, frameworks and applications',
                'color': self.colors['accent_purple'],
                'icon': 'WEB',
                'object_count': '7 objects'
            }
        ]
    ...
    def get_objects_preview(self, category_name):
        previews = {
            'Operating Systems': 'Includes: Windows 10/11, Ubuntu, Arch Linux, Files, Folders',
            'Network Devices': 'Includes: Computers, Servers, Routers, Switches, Firewalls',
            'Web Technologies': 'Includes: Apache, Nginx, MySQL, MongoDB, Django, Flask',
