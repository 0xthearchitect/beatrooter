...
<p align="center">
  <img src="./assets/beatrooter_logo.svg" width="200">
</p>
...
O projeto está a ser preparado para uma organização por feature, com cada domínio a ter a sua própria pasta de `ui`, `core`, `models` e `integrations` quando fizer sentido.

A proposta detalhada está em [docs/arquitetura-modular.md](docs/arquitetura-modular.md).
